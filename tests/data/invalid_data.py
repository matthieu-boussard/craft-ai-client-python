...
INVALID_OUTPUTS = {"no_output": None, "output_not_in_the_configuration": ["beerBrand"]}

UNDEFINED_KEY = {"none": None, "empty_string": "", "empty_dict": {}, "empty_list": []}

INVALID_TIME_QUANTA = {"negative_tq": -42, "null_tq": 0}

INVALID_TIMESTAMPS = {"negative_ts": -42, "null_ts": None, "float_ts": 3.141592}
